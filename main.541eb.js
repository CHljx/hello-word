(function () {
    ...
    function boot () {
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.e476b.js' : 'src/project.js';
            if (jsList) {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.43d92.js' : 'cocos2d-js-min.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.43d92.js' : 'cocos2d-js-min.js';
